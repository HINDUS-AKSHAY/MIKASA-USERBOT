...
@bot.on(deadly_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
@bot.on(deadly_cmd(outgoing=True, pattern="krb"))
...
async def carbon_api(e):
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await deadly.edit("`Making Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
@bot.on(deadly_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
...
@bot.on(deadly_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
@bot.on(deadly_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
@bot.on(deadly_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
...
@bot.on(deadly_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
@bot.on(deadly_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
