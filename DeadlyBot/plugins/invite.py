...
@bot.on(deadly_cmd(pattern=r"inviteall ?(.*)"))
...
async def get_users(event):
    ...
    if he_ll == "@deadly_kaal_support":
        return await deadly.edit("Restricted to invite users from there.")
    elif he_ll == "@deadly_kaal_support":
        return await deadly.edit("Restricted to invite users from there.")
    ...
    await deadly.edit("**INVITING USERS !!**")
...
@bot.on(deadly_cmd(pattern=r"add ?(.*)"))
