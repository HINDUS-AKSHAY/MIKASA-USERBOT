...
@bot.on(deadly_cmd(pattern=r"trc", outgoing=True))
...
@bot.on(deadly_cmd(pattern="voice (.*)"))
...
CmdHelp("google_asst").add_command(
  "voice", "<reply to a msg> <lang code>", "Sends the replied msg content in audio format."
    ...
    "trt", "<lang code> <reply to msg>", "Translates the replied message to desired language code. Type '.trc' to get all the language codes", f"trt en - deadlyo | {hl}trt en <reply to msg>"
).add_command(
