...
@bot.on(deadly_cmd(pattern=r"tweet(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"mia(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"cmm(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern=r"kanna(?: |$)(.*)"))
