...
BELLO = [
    ...
    '`"Teeth constantly require maintenance to prevent their decay when deadly, and yet they manage to survive for thousands of years buried as fossils."`',
