...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "༺ ʟɛɢɛռɖǟʀʏ ǟʄ ɖɛǟɖʟʏ ɮօȶ ༻")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "꧁༺ ʟɛɢɛռɖǟʀʏ ǟʄ ɖɛǟɖʟʏ ɮօȶ ༻꧂")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "DEADLY_TECHY")
    MY_GROUP = os.environ.get("YOUR_GROUP", "deadly_danav_support")
    ...
    DEADLY_DANAV_SESSION = os.environ.get("DEADLY_DANAV_SESSION", None)
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/DEADLY-FIGHTERS/DEADLY-DANAV-BOT")
